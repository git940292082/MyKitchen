...
import sc.my.mykitchen.R.drawable;
...
public class BaiduNaviActivity extends Activity {
	  ...
	  private final String TAG = BaiduNaviActivity.class.getName();
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        BaiduSearchActivity.activityList.add(this);
	        createHandler();
	        ...
	        if (intent != null) {
	            ...
	            if (bundle != null) {
	                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(BaiduSearchActivity.ROUTE_PLAN_NODE);
	            }
	        }
	        //显示自定义图标
	        if (hd != null) {
	    ...
	    protected void onDestroy() {
	        ...
	        BaiduSearchActivity.activityList.remove(this);
	    ...
	    private void addCustomizedLayerItems() {
	        ...
	        if (mBNRoutePlanNode != null) {
	            item1 = new CustomizedLayerItem(mBNRoutePlanNode.getLongitude(), mBNRoutePlanNode.getLatitude(),
	                    mBNRoutePlanNode.getCoordinateType(), getResources().getDrawable(R.drawable.navi_map_gps_locked),
